    ...
    />
        ...
        {/* image blurb/welcome */}
            ...
            className='max-w-2xl mx-auto font-Ovo'>
                Experienced front end web developer, currently working on front end and full stack projects @ Livewell Southwest.
            </motion.p>
            ...
            <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
                ...
                href="#Peter_Andrew_CV_2025.pdf" download className='px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2
